...
export default function BlogIndexPage({ posts, onOpenPost, onNavigate }) {
      ...
      {featuredPost && (
        <section>
          ...
          <button
            ...
            className="text-left w-full bg-white border-2 border-brand-mughal-green rounded-xl p-8 hover:shadow-lg transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring group"
          >
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="px-8 py-3 bg-white text-brand-mughal-green rounded-lg font-medium text-sm hover:shadow-lg transition-all duration-200"
            >
              Get Early Access
            </button>
            <button
              ...
              className="px-8 py-3 bg-white/10 backdrop-blur-sm text-white border border-white/20 rounded-lg font-medium text-sm hover:bg-white/20 transition-all duration-200"
            >
              View Documentation
            </button>
          </div>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <button
              type="button"
              onClick={() => onNavigate?.('documentation')}
              className="px-6 py-3 bg-brand-mughal-green text-white rounded-lg font-medium text-sm hover:bg-brand-mughal-green-2 transition-all duration-200 whitespace-nowrap"
            >
              View Documentation →
            </button>
          </div>
