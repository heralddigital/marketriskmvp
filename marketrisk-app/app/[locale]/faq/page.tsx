...
function FAQItem({ question, answer }: { question: string, answer: string, category: string }) {
...
export default function FAQPage() {
    ...
    return (
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 py-12 md:py-20 space-y-12">
            {/* Hero Section */}
            <section>
                <div className="text-center max-w-3xl mx-auto">
                    ...
                    <p className="text-lg text-text-secondary mb-8">
                        ...
                        <Link
                            href="/contact"
                            className="text-brand-mughal-green hover:text-brand-mughal-green-2 font-medium ml-1 underline transition-colors"
                        >
                    ...
                    <div className="relative max-w-2xl mx-auto">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-3 bg-white border border-border-subtle rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-mughal-green focus:border-transparent text-text-primary placeholder:text-text-muted transition-shadow"
                        />
                    </div>
                </div>
            </section>
                ...
                <div className="flex flex-wrap gap-3 justify-center">
                    {faqCategories.map((category) => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-normal border ${selectedCategory === category.id
                                    ? 'bg-brand-mughal-green text-white border-transparent'
                                    : 'bg-white text-text-primary border-border-subtle hover:bg-surface-paper'
                                }`}
                        >
                            {category.label}
                            {category.count > 0 && (
                                <span className={`ml-2 px-2 py-0.5 rounded text-xs ${selectedCategory === category.id
            ...
            <section>
                {filteredFAQs.length > 0 ? (
                    ...
                    <div className="text-center py-12 bg-white border border-border-subtle rounded-xl max-w-4xl mx-auto">
                        ...
                        <button
                            ...
                            className="text-sm text-brand-mughal-green hover:text-brand-mughal-green-2 font-medium underline transition-colors"
                        >
                            Clear filters
                        </button>
                    </div>
            ...
            <section className="bg-brand-mughal-green rounded-2xl p-8 md:p-12 relative overflow-hidden max-w-6xl mx-auto">
                ...
                <div className="relative z-10 max-w-3xl mx-auto text-center">
                    ...
                    <h2 className="text-3xl md:text-4xl font-semibold text-text-inverse mb-4 tracking-tight">
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 text-sm text-text-inverse-muted">
