...
import { Bell, AlertCircle, CheckCircle2, TrendingDown, Building2, Mail, Smartphone, X, Clock } from 'lucide-react'
...
const mockAlerts = [
  {
    ...
    type: 'risk_decrease',
    severity: 'high',
    company: 'SC IMPORT EXPORT SRL',
    cui: '34567890',
    message: 'Scorul de risc a scăzut de la 50 la 38 (-12 puncte)',
    timestamp: '2 ore în urmă',
    read: false,
    details: 'Risc fiscal detectat. Se recomandă verificare urgentă.',
  },
  {
    id: 2,
    type: 'status_change',
    severity: 'medium',
    company: 'SC CONSULTING GROUP SA',
    cui: '23456789',
    message: 'Modificare status: proces în desfășurare',
    timestamp: '5 ore în urmă',
    read: false,
    details: 'Un proces civil a fost înregistrat la instanță.',
  },
  {
    id: 3,
    type: 'financial_change',
    severity: 'low',
    company: 'SC TECH SOLUTIONS SRL',
    cui: '12345678',
    message: 'Scorul de risc a crescut cu 2 puncte',
    timestamp: '1 zi în urmă',
    read: true,
    details: 'Îmbunătățiri în indicatorii financiari.',
  },
  {
    id: 4,
    type: 'data_update',
    severity: 'low',
    company: 'SC PRODUCTION FACTORY SRL',
    cui: '45678901',
    message: 'Date actualizate din ANAF',
    timestamp: '2 zile în urmă',
    read: true,
    details: 'Bilanț contabil actualizat pentru anul fiscal 2024.',
  },
]
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="font-semibold text-[var(--text-primary)]">{alert.company}</h3>
                          {!alert.read && (
                    ...
                    <div className="flex items-center gap-2 mt-4 pt-4 border-t border-[var(--border-subtle)]">
                      ...
                      <button className="px-3 py-1.5 text-sm font-medium text-[var(--text-secondary)] hover:bg-[var(--surface-bone)] rounded-[4px] transition-colors">
                        Vezi compania
                      </button>
                      <button
